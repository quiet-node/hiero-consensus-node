...
public class DockerInit {
    ...
    private static final String APP_NAME = "org.hiero.consensus.otter.docker.app.DockerInit";
    ...
    public static void main(String[] args) throws Exception {
        ...
        final var platformBuilder = PlatformBuilder.create(
                ...
                .withSystemTransactionEncoderCallback(DockerInit::encodeSystemTransaction);

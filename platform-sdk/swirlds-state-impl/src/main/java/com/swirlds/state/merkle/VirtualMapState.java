...
public abstract class VirtualMapState<T extends VirtualMapState<T>> implements State {
     ...
     */
    public VirtualMapState(VirtualMap virtualMap, @NonNull final PlatformContext platformContext) {
    ...
    public T loadSnapshot(@NonNull Path targetPath) throws IOException {
        final MerkleNode root = MerkleTreeSnapshotReader.readStateFileData(
                        platformContext.getConfiguration(), targetPath)
                .stateRoot();
    ...
    public final class MerkleWritableStates extends MerkleStates implements WritableStates, CommittableWritableStates {
        ...
        public void copyAndReleaseVirtualMap(@NonNull final String stateKey) {
            ...
            mutableCopy.getVirtualMap().registerMetrics(platformContext.getMetrics());
            binaryState.release();
    ...
    public String getInfoJson() {
        ...
        final VirtualMap virtualMap = binaryState.getVirtualMap();

...
public class StateMetadataTest extends StateTestBase {
    ...
    void nullStateKeyThrows() {
        //noinspection DataFlowIssue
        assertThatThrownBy(() -> StateMetadata.validateStateKey(null)).isInstanceOf(NullPointerException.class);
    }

    @Test
    @DisplayName("Validating a state key with no characters throws an exception")
    void emptyStateKeyThrows() {
        assertThatThrownBy(() -> StateMetadata.validateStateKey(""))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void invalidStateKeyThrows(final String stateKey) {
        assertThatThrownBy(() -> StateMetadata.validateStateKey(stateKey)).isInstanceOf(IllegalArgumentException.class);
    }

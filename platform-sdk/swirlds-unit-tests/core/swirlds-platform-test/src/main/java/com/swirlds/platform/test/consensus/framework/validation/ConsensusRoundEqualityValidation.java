...
public class ConsensusRoundEqualityValidation {
    public static void validateConsensusRounds(
            final List<ConsensusRound> consensusRoundsForNode1, final List<ConsensusRound> consensusRoundsForNode2) {
        validateIterableRounds(consensusRoundsForNode1.iterator(), consensusRoundsForNode2.iterator());

        assertEquals(
                consensusRoundsForNode1.size(),
                consensusRoundsForNode2.size(),
                String.format(
                        "The number of consensus rounds is not the same."
                                + "output1 has %d rounds, output2 has %d rounds",
                        consensusRoundsForNode1.size(), consensusRoundsForNode2.size()));
    }

...
public class MerkleStateUtils {
    ...
    public static String createInfoString(
        ...
        //        final List<MinimumJudgeInfo> minimumJudgeInfo = snapshot == null ? null :
        // snapshot.minimumJudgeInfoList();
        ...
        //                .addRow("Legacy running event mnemonic:", hashEventsCons == null ? "null" :
        // hashEventsCons.toMnemonic())
        ...
        //                .addRow("Minimum judge hash code:", minimumJudgeInfo == null ? "null" :
        // minimumJudgeInfo.hashCode())
        ...
        //                .addRow("Lowest Judge Gen before BR",

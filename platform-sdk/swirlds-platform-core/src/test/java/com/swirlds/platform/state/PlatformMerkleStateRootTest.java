...
class PlatformMerkleStateRootTest extends MerkleTestBase {
    ...
    //            assertThatThrownBy(() ->
    //                            stateRoot.putServiceStateIfAbsent(fruitMetadata, () ->
    ...
    //            setupFruitVirtualMap();
    //            assertThatThrownBy(() -> stateRoot.putServiceStateIfAbsent(fruitVirtualMetadata, () ->
    // fruitMerkleMap))
    //                    .isInstanceOf(IllegalArgumentException.class)
    ...
    //            stateRoot.init(
    //                    platformContext.getTime(), platformContext.getMetrics(),

...
public interface VirtualRoot<K extends VirtualKey, V extends VirtualValue> extends MerkleNode {
     ...
     * boolean, boolean)} method. It will contain the same data as this root, but some data may be moved from memory
     * to disk or vice versa. After snapshot is taken, it does not consume any runtime resources, CPU or memory.
     *

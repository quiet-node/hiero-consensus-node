...
/**
 * Configuration for realistic geographic latency simulation. Defines the distribution of node connections across geographic boundaries and the latency characteristics for each type of connection.
 */
@SuppressWarnings("unused")
public record GeographicLatencyConfiguration(
        Percentage sameRegionPercent,
        Percentage sameContinentPercent,
        @NonNull LatencyRange sameRegion,
        @NonNull LatencyRange sameContinent,
        @NonNull LatencyRange intercontinental) {

    /**
     * Default configuration with 20% same-region, 40% same-continent, and 40% intercontinental distribution, using standard latency ranges.
     *
     * <table>

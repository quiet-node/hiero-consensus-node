...
module com.hedera.services.yahcli {
	...
	opens com.hedera.services.yahcli.commands.files to
			info.picocli;
	opens com.hedera.services.yahcli.commands.keys to info.picocli;
	opens com.hedera.services.yahcli.commands.nodes to info.picocli;
	opens com.hedera.services.yahcli.commands.schedules to info.picocli;
	opens com.hedera.services.yahcli.commands.system to info.picocli;
//	// For test visibility
//	opens com.hedera.services.yahcli to

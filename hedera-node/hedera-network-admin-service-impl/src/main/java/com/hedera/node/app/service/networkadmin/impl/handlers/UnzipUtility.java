...
public final class UnzipUtility {
    ...
    private static final long THRESHOLD_ENTRIES = 10000; // max # of entries to allow in zip files
    private static final long THRESHOLD_ZIP_SIZE = 1000000000000L; // 1 TB - max allowed total size of all uncompressed files
    private static final long THRESHOLD_ENTRY_SIZE = 50000000000L; // 50 GB - max allowed size of one uncompressed file
    ...
    public static void unzip(@NonNull final byte[] bytes, @NonNull final Path dstDir) throws IOException {
        ...
        long totalSizeArchive = 0; // total size of the zip archive once uncompressed
        long totalEntryArchive = 0; // total number of entries in the zip archive

...
/**
 * Defines a translator for a token associate transaction into a {@link SingleTransactionRecord}.
 */
public class TokenAssociateTranslator implements BlockTransactionPartsTranslator {
    @Override

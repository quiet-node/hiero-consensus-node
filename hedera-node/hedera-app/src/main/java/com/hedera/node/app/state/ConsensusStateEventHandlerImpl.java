 ...
 */
public class ConsensusStateEventHandlerImpl implements ConsensusStateEventHandler<HederaNewStateRoot> {
    ...
    public void onPreHandle(
            ...
            @NonNull final HederaNewStateRoot state,
    ...
    @Override
    public boolean onSealConsensusRound(@NonNull final Round round, @NonNull final HederaNewStateRoot state) {
    ...
    public void onUpdateWeight(
            @NonNull final HederaNewStateRoot stateRoot,
    ...
    @Override
    public void onNewRecoveredState(@NonNull final HederaNewStateRoot recoveredStateRoot) {

...
public final class StreamFileProducerConcurrent implements BlockRecordStreamProducer {
                            ...
                            twoResults -> {
                                ...
                                serializedItems.forEach(item -> {
                                    try {
                                        ...
                                        executionOutputCache.addRecordStreamItem(writer.getBlockNumber(), item);
    ...
    private BlockRecordWriter createBlockRecordWriter(
        ...
        try {
            ...
            executionOutputCache.createRecordStreamBlock(
                    hapiVersion, startRunningHash, startConsensusTime, blockNumber);
            return writer;
        } catch (final Exception e) {
    ...
    private void closeWriter(BlockRecordWriter writer, Bytes lastRunningHash) {
        ...
        try {
            ...
            executionOutputCache.closeRecordStreamFile(writer.getBlockNumber(), asHashObject(lastRunningHash));
        } catch (final Exception e) {

...
class HintsLibraryImplTest {
    ...
    void nothingSupportedYet() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> subject.computeHints(Bytes.EMPTY, Bytes.EMPTY, 1, 1));
        assertThrows(
                UnsupportedOperationException.class, () -> subject.validateHintsKey(Bytes.EMPTY, Bytes.EMPTY, 1, 1));
        assertThrows(UnsupportedOperationException.class, () -> subject.preprocess(Bytes.EMPTY, Map.of(), Map.of(), 1));
        assertThrows(UnsupportedOperationException.class, () -> subject.signBls(Bytes.EMPTY, Bytes.EMPTY));
        assertThrows(
                UnsupportedOperationException.class,
                () -> subject.verifyBls(Bytes.EMPTY, Bytes.EMPTY, Bytes.EMPTY, Bytes.EMPTY));
        assertThrows(
                UnsupportedOperationException.class,
                () -> subject.aggregateSignatures(Bytes.EMPTY, Bytes.EMPTY, Bytes.EMPTY, Map.of()));
    }
}

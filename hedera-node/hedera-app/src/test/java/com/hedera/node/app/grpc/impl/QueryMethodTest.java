...
final class QueryMethodTest {
    ...
    void nullServiceNameThrows() {
        ...
        assertThrows(
                ...
                () -> new QueryMethod(null, METHOD_NAME, queryWorkflow, metrics, bufferSize));
    }
    ...
    void nullMethodNameThrows() {
        ...
        assertThrows(
                NullPointerException.class,
                () -> new QueryMethod(SERVICE_NAME, null, queryWorkflow, metrics, bufferSize));
    }
    ...
    void nullWorkflowThrows() {
        ...
        assertThrows(
                NullPointerException.class,
                () -> new QueryMethod(SERVICE_NAME, METHOD_NAME, null, metrics, bufferSize));
    }
    ...
    void nullMetricsThrows() {
        ...
        assertThrows(
                NullPointerException.class,
                () -> new QueryMethod(SERVICE_NAME, METHOD_NAME, queryWorkflow, null, bufferSize));
    }
    ...
    void parseStreamThatIsTooBig(int numBytes) {
        ...
        final var method = new QueryMethod(SERVICE_NAME, METHOD_NAME, w, metrics, bufferSize);

...
class WritableEntityIdStoreTest {
    ...
    private final WritableSingletonState<EntityNumber> entityIdState =
            new FunctionWritableSingletonState<>(EntityIdService.NAME, ENTITY_ID_STATE_KEY, nextEntityNumber::get, nextEntityNumber::set);
    private final WritableSingletonState<EntityCounts> entityCountsState =
            new FunctionWritableSingletonState<>(EntityIdService.NAME, ENTITY_COUNTS_KEY, entityCounts::get, entityCounts::set);

...
class MerkleSchemaRegistryTest extends MerkleTestBase {
    ...
    class RegistrationTest {
        ...
        void migrateFromV9ToV10() {
            ...
            schemaRegistry.migrate(
                    new TestVirtualMapMerkleNodeState(virtualMap),
                    version(9, 0, 0),
                    latestVersion,
                    config,
                    config,
    ...
    class MigrationTest {
        ...
        void setUp() {
            ...
            final var virtualMapLabel =
                    "vm-" + MerkleSchemaRegistryTest.class.getSimpleName() + "-" + java.util.UUID.randomUUID();
            merkleTree = TestVirtualMapMerkleNodeState.createInstanceWithVirtualMapLabel(virtualMapLabel);
        }
        ...
        class StateImpactTest {
            ...
            Schema createV2Schema() {
                return new TestSchema(versions[2]) {
                    ...
                    public Set<StateDefinition> statesToCreate() {
                        final var animalDef =
                                StateDefinition.onDisk(ANIMAL_STATE_KEY, ProtoBytes.PROTOBUF, STRING_CODEC, 100);
            ...
            void genesis() {
                ...
                final ReadableKVState<ProtoBytes, String> fruitV1 = readableStates.get(FRUIT_STATE_KEY);

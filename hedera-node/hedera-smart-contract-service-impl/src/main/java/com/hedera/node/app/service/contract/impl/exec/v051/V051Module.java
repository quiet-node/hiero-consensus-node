...
/**
 * Provides the Services 0.51 EVM implementation, which consists of Cancun operations and
 * precompiles plus the Hedera gas calculator, system contracts, and operations
 * as they were configured in the 0.51 release (with support for Hedera Account Service system contract calls
 * at address 0x16a).
 */
@Module
public interface V051Module {
    ...
    @Binds
    @ServicesV051
    FeatureFlags bindFeatureFlags(Version051FeatureFlags featureFlags);
    ...
    static Operation provideSelfDestructOperation(
            @NonNull final GasCalculator gasCalculator, @ServicesV051 @NonNull final AddressChecks addressChecks) {
